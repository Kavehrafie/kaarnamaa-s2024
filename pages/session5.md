...
<!-- 
there is no more chance in art than there is in mechanics. A fortunate discovery is the simple consequence of good reasoning, from which one can sometimes omit the intervening deductions, just like a mistake is the  consequence of a false principle. A painting is a machine, in which all the systems are visible to a practiced eye; where everything has a reason for being, if the painting is good; where one tone is always destined to accent another; where an occasional shortcoming in drawing is sometimes necessary, to avoid sacrificing something of greater importance.
-->
...
<!-- 
"if I represent a Christ or a saucepan since it's the form, and not the object itself, that interest me." (Fry)
-->
